...
CREATE TABLE bulletin_board_items (
    ...
    created_by_name VARCHAR (511) NOT NULL DEFAULT '',
    created_from_ip VARCHAR (50) NOT NULL DEFAULT '',
    last_modified_by_name VARCHAR (511) NOT NULL DEFAULT '',
    last_modified_time TIMESTAMP NOT NULL DEFAULT (now() AT TIME ZONE 'utc'),
...
CREATE TABLE work_orders (
    ...
    customer_lexical_name VARCHAR (255) NULL DEFAULT '',
    associate_id BIGINT NULL,
    associate_name VARCHAR (255) NULL,
    associate_lexical_name VARCHAR (255) NULL,
    description TEXT NOT NULL DEFAULT '',
...
CREATE TABLE customers (
    ...
    lexical_name VARCHAR (255) NOT NULL DEFAULT '',
...
CREATE TABLE staff (
    ...
    deactivation_reason_other VARCHAR (2055) NOT NULL DEFAULT '',
    created_time TIMESTAMP NOT NULL DEFAULT (now() AT TIME ZONE 'utc'),
    created_from_ip VARCHAR (50) DEFAULT '',
    created_by_id BIGINT NULL,
    created_by_name VARCHAR (511) NULL,
    last_modified_by_id BIGINT NULL,
    last_modified_by_name VARCHAR (511) NULL,
    ...
    address_region VARCHAR (127) NOT NULL DEFAULT '',
    address_locality VARCHAR (127) NOT NULL DEFAULT '',
    post_office_box_number VARCHAR (255) NULL DEFAULT '',
    postal_code VARCHAR (127) NOT NULL DEFAULT '',
    street_address VARCHAR (127) NOT NULL DEFAULT '',
    ...
    middle_name VARCHAR (63) NULL DEFAULT '',
    last_name VARCHAR (63) NULL DEFAULT '',
    name VARCHAR (255) NOT NULL DEFAULT '',
    lexical_name VARCHAR (255) NOT NULL DEFAULT '',
    birthdate VARCHAR (31) NULL DEFAULT '',
    join_date TIMESTAMP NULL DEFAULT (now() AT TIME ZONE 'utc'),
    nationality VARCHAR (63) NULL DEFAULT '',
    gender VARCHAR (31) NULL DEFAULT '',
    tax_id VARCHAR (127) NULL DEFAULT '',
    ...
    -- abstract_contact_point.py
    area_served VARCHAR (127) NULL DEFAULT '',
    available_language VARCHAR (127) NULL DEFAULT '',
    contact_type VARCHAR (127) NULL DEFAULT '',
    email VARCHAR (255) NOT NULL DEFAULT '',
    fax_number VARCHAR (127) NULL DEFAULT '',
    telephone VARCHAR (127) NULL DEFAULT '',
    telephone_type_of SMALLINT NULL DEFAULT 0,
    telephone_extension VARCHAR (31) NULL DEFAULT '',
    other_telephone VARCHAR (127) NULL DEFAULT '',
    other_telephone_extension VARCHAR (31) NULL DEFAULT '',
    other_telephone_type_of SMALLINT NULL DEFAULT 0,
